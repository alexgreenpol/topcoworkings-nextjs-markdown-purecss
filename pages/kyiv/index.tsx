...
export default function Kyiv({ coworkings }: any) {
    return (
        <>
            <Head>
                <title>
                    Коворкінги Києва 2023 (фото + ціни + тарифи) |
                    Topcoworking.com.ua
                </title>
                <meta
                    name="title"
                    content="Коворкінги Києва 2023 (фото + ціни + тарифи)"
                />
                <meta
                    name="description"
                    content="Огляд всіх коворкінгів Києва з фотографіями, описом і цінми."
                />
                <meta
                    property="og:title"
                    content="Коворкінги Києва 2023 (фото + ціни + тарифи)"
                ...
                <meta
                    ...
                    content="Огляд всіх коворкінгів Києва з фотографіями, описом і цінами."
                />
                ...
                <div className="container">
                    <div className="pure-g">
                        <div className="pure-u-1">
                            <h1>
                                Огляд всіх коворкінгів Києва 2023 (фото + ціни +
                                тарифи)
                            </h1>
