...
export default function CoworkingPageTemplateRu({
    frontmatter,
    content,
    city,
    ...
    return (
        <>
            <Head>
                <title>
                    {`Коворкинг ${coworkingName} в ${city.three} | описание,
                    галерея, цены, адрес`}
                </title>
                <meta
                    name="title"
            ...
            >
                <Heading customBgImage={socialImage}>
                    <h1 itemProp="headline">Коворкинг {coworkingName}</h1>
                    ...
                    <div className="pure-g">
                        <div className="pure-u-1">
                            ...
                            <div className="sector content">
                                <h2>Подробно о {coworkingName}</h2>
                                <div
